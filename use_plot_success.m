function use_plot_success(f,init_result,aim_alph,updata_alph,num_frequent,count,round,target_frequent)





alph_e=updata_alph-aim_alph;%当前与目标吸声系数误差
a=mean(abs(alph_e));
a_str = sprintf('%.3f ', a);

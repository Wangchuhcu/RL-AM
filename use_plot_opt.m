function use_plot_opt(f,init_result,aim_alph,draw_alph,num_frequent,count,time_opt,target_frequent)
...
title("对最小误差结果进行优化","第"+b_str+"轮"+"第"+c_str+"次优化");
legend('当前', '','', '目标');
